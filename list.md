...
Galaxyfly是由Galaxy图和全连接图一起组成的一种拓扑结构，它的一些主要参数如下：
!['Galaxyfly的主要参数'](./03.png)
n = 3, q = 5, a = 2, h = 2的Galaxyfly拓扑如下所示：
!['Galaxyfly样例'](./04.png)

论文在BookSim模拟器上对比了Galaxyfly和其他拓扑结构，结果显示其在功率和性能等各方面均表现优异。
